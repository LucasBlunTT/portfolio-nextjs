    ...
    <HeaderStyle>
      <Container data-aos="fade-up">
        ...
        <nav className='navigation'>
          <ul>
            <li key={1}><Link href="https://github.com/LucasBlunTT" target='_blank'><i className="devicon-github-original"></i></Link></li>
            <li key={2}><Link href="https://www.linkedin.com/in/lucas-da-silva-b63b59a3/"><i className="devicon-linkedin-plain" target='_blank'></i></Link></li>
          </ul>
        </nav>
      </Container>
    </HeaderStyle>
