      ...
      <Container>
        ...
        <div className='slide-cases' data-aos='zoom-in'>
          ...
          >
            <SwiperSlide>
              <Link
                href={'https://projeto-blizzard-redesign.netlify.app/'}
                target='_blank'
              >
                <div className='image'>
            ...
            <SwiperSlide>
              <Link
                href={'https://lucasbluntt-projeto-neon.netlify.app/'}
                target='_blank'
              >
                <div className='image'>
            ...
            <SwiperSlide>
              <Link
                href={'https://whatif-codeboost-iota.vercel.app/'}
                target='_blank'
              >
                <div className='image'>
            ...
            <SwiperSlide>
              <Link
                href={'https://god-of-war-ragnarok-redesign.netlify.app/'}
                target='_blank'
              >
                <div className='image'>
            ...
            <SwiperSlide>
              <Link
                href={'https://ricky-and-morty-react.netlify.app/'}
                target='_blank'
              >
                <div className='image'>
            ...
            <SwiperSlide>
              <Link
                href={'https://projeto-pokemon-api.netlify.app/'}
                target='_blank'
              >
                <div className='image'>
